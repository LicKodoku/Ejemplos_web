...
<center>
<table border="1">
  <tr bgcolor="#336699" style="color:#FF6";><td>No. Cuenta</td><td>Nombre</td><td>Edad</td><td>Materia</td><td>Turno</td><td>Comentarios</td><td>Eliminar</td></tr>
<?php
...
?> 
  <tr bgcolor="#CEF6F5" onmouseover="this.style.background='#FFD961';" onmouseout="this.style.background='#CEF6F5';">
     ...
     <td> <a href="eliminacion.php?idalumno=<?php echo $lafila['nocta']; ?>">Eliminar</a> </td>
  </tr>
<?php
   }//fin del while
 }
